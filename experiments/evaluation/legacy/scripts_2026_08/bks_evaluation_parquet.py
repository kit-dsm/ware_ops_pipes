...
def summary_table(cmp):
    order = [
        ...
        ("MuterOencan", "distance"), ("MuterOencanWG", "distance"), ("Foodmart", "distance"),
...
def plot_gaps(cmp, path):
    ...
    groups = [
        ["SPRP", "SPRP-SS"],
        ["BahceciOencan", "HennWaescher", "MuterOencan", "MuterOencanWG", "Foodmart",
...
def main():
    required = [DF_RESULTS, SPRP, SPRP_SS, BAHCECI, MUTER, MUTER_WG_BKS, HENN_IDENTIFIERS, HENN_BKS, FOODMART_BKS, KRIS_SMALL, KRIS_LARGE]
    ...
    if len(improvements):
        ...
        print("Inspect bks_improvements_over_published.csv for the instance-level rows.")
