...
def postprocess(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # load_summary_jsons_fast uses parallel file loading, so stabilize row order
    # before serializing the publication result table.
    sort_cols = [
        c for c in [
            "instance_set",
            "instance_name",
...
def main() -> None:
    ...
    # Parquet is the canonical publication artifact.
