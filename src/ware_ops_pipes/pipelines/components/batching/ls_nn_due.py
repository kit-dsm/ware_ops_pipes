from ware_ops_algos.algorithms import LocalSearchBatching, NearestNeighbourhoodRouting, DueDateBatching
...
class LSBatchingNNDueDate(BatchedPickListGeneration):
    abstract = False
    ...
    def get_inited_batcher(self):
        ...
        batcher = LocalSearchBatching(#capacity=resources.resources[0].capacity,
                                      ...
                                      start_batching_class=DueDateBatching,
                                      time_limit=240)
        return batcher
