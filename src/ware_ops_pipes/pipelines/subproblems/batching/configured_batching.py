...
from ware_ops_algos.algorithms import (
    ...
    SeedBatching,
    ClosestToDepotSeed,
    MinDistanceSimilarity, RatliffRosenthalRouting, ClarkAndWrightBatching,
)
...
class ConfiguredSeedBatching(MultiOrderBatching):
    ...
    def get_inited_batcher(self) -> SeedBatching:
...
class ConfiguredClarkAndWrightBatching(MultiOrderBatching):
    abstract = True
